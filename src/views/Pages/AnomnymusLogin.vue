...
<template>
  <AlertWarning />
  <div class="w-2/3 m-auto h-2/3 p-auto">
    <DefaultCard class="p-7">
      <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
        <div class="w-full p-4">
          <span class="mb-1.5 block font-medium">A few steps to your account</span>
          <h2 class="mb-3 text-xl font-bold text-black dark:text-white sm:text-title-xl2">
            Login to your DIT grivance account
          </h2>
