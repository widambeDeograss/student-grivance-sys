    ...
    setup() {
        ...
        onMounted(async () => {
            try {
                ...
                alertStore.addAlert({ title: 'Error', message: 'Failed to fetch divisions', duration: 3000, type: 'error' })
            }
        })
...
<template>
    <div>
                    ...
                    <ul class="flex items-center gap-2 2xsm:gap-4">
                        ...
                        <router-link to="/anomnimus/login">
                            ...
                            <li class="flex p-3 hover:shadow-4 hover:bg-primary  hover:text-white">
                                ...
                                <svg class="fill-current mt-1 mr-1" width="18" height="19" viewBox="0 0 18 19"
        ...
        <div class="flex flex-col gap-9 ">
            ...
            <!-- Contact Form Start -->
            <div class="p-4">
                <h2 class="text-lg font-bold mb-1  px-10">Take two steps to submit your grivance Anomnymusly,</h2>
                    ...
                    <div class="w-full max-w-full px-3 mt-6 md:flex-none">
                        <div
                            ...
                            <div class="mb-6 mt-3">
                                ...
                                <textarea rows="6" placeholder="Type your grivance" required v-model="message"
                ...
                <div v-else-if="currentStep === 2" class="bg-gray-200 p-4 rounded-lg">
                    <div class="w-full max-w-full px-3 mt-6 md:flex-none">
                        <div
                            ...
                            <div class="border-2 border-dashed border-gray-400 p-4 mb-4 rounded-lg" @dragover.prevent
                                @drop="handleDrop">
                                <p class="text-center mb-2">Drag and drop your file here or</p>
                                <input type="file" @change="handleFileChange" ref="fileInput" :accept="acceptedFileType"
                                    class="hidden">
                            ...
                            <div class="flex justify-between items-center">
                                <button @click="prevStep"
                                    class="bg-blue-500 text-white px-4 py-2 rounded ml-2 hover:bg-gray-600">Back</button>
