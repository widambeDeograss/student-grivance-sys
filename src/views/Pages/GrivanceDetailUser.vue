...
<template>
    ...
    <header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark mt-5 mx-5">
            <div class="card p-3">
                <div class="card-body">
                    <div class="table-top">
                        ...
                        <table class="table datanew w-full p-5 text-left">
                            ...
                            <tbody class="p-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-sm font-medium text-meta-3 animate-pulse" v-if="data?.problem_solved_state">
                                            Solved
                                        </p>
                                        <p class="text-sm font-medium text-meta-6 animate-pulse"
