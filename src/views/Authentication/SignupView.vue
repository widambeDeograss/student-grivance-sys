...
const register = async () => {
  ...
  try {
    ...
    const response: any = await authStore.register(authUrls.register, body)
    ...
    if (response.data?.save) {
      ...
      router.push({ name: 'AnomnimusLogin' })
    } else {
      alertStore.addAlert({
...
<template>
  ...
  <AlertWarning />
  <DefaultAuthCard
    subtitle="A few steps to your new account"
    title="Sign up to your new DIT grivance account"
  >
    <form @submit.prevent="register">
      ...
      <div class="mt-6 text-center">
        <p class="font-medium">
          ...
          <router-link to="/anomnimus/login" class="text-primary">Sign in</router-link>
        </p>
      </div>
    </form>
  </DefaultAuthCard>
