...
onMounted(async () => {
  try {
    ...
    const ress = await divisionStore.getAllProblems(DivisionUrls.allDivisions + `?querytype=all`);
    console.log(ress);
    divisions.value = ress;
  ...
  <DefaultLayout>
    ...
    <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div class="py-6 px-4 md:px-6 xl:px-7.5 flex justify-between">
        ...
        <ButtonDefault route="/dashboard/add_division" label="ADD DIVISION"
